    ...
    void requestRandomBeer(){
        connection.RequestBeer(getApplicationContext(),new ActivityCallback() {
            ...
            public void onResponse(Beer randomBeer) {
                String name = randomBeer.getData().getStyle().getName();
                String description = randomBeer.getData().getStyle().getDescription();
                String labelUrl = randomBeer.getData().getLabelFromKey("large");
